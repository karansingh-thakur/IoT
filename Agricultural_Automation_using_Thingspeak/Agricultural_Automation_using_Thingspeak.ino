...
String apiKey = "4HDLTV21HI5BJ10A";     //  Enter  Write API key here
const char* server = "api.thingspeak.com";
const char *ssid =  "Thakur";     // Enter  WiFi Name
const char *pass =  "Karan@85"; // Enter  WiFi Password
#define DHTPIN 5          // GPIO Pin where the dht11 is connected
DHT dht(DHTPIN, DHT11);
WiFiClient client;

const int moisturePin = A0;             // moisteure sensor pin
const int motorPin = 4;                // motor sensor pin
...
//if (moisturePercentage > 10 && moisturePercentage < 20) {
